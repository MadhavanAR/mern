...
> Minimal FastAPI agent template with Supabase or PostgreSQL conversation storage.
...
This is a sample Python FastAPI agent demonstrating the minimal components to build a production-ready AI agent. It serves as a template and reference implementation for creating new Python-based agents.
...
1. **Clone Repository**
   ...
   cd Agents/templates/python-agent
